...
export default function PlansManager({ token, onViewUsers }) { 
        ...
        <div className="space-y-6">
            ...
            {isModalOpen && mounted && createPortal(
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-[#181820] border border-white/10 rounded-2xl w-full max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl flex flex-col">
                        <div className="p-6 border-b border-white/10 flex justify-between items-center sticky top-0 bg-[#181820] z-10 shrink-0">
